...
#include "3_table1.h"    // Provides the Table class
...
int main( )
{
    ...
    cout << "Initialized an empty table. Each record in the table\n";
...
void print_menu( ) // Library facilities used: iostream.h
{
...
char get_user_command( ) // Library facilities used: iostream.h
{
    char command;
    ...
    return command;
}// end of get_user_command()


test_record_type get_record( ) // Library facilities used: iostream.h
{
...
int get_key( ) // Library facilities used: iostream.h
{
    int key;
